...
class FundTransfer extends Transaction {
    ...
    public FundTransfer(String id, Date date, double amount, String destinationAccount, String notes) {
        super(id, date, amount);
...
class BillPayment extends Transaction {
    ...
    public BillPayment(String id, Date date, double amount, String billId, String paymentMethod) {
        super(id, date, amount);
        this.billId = billId;
...
public class App {
    public static void main(String[] args) {
        ...
        // Transfer
        Transaction transfer = new FundTransfer("TX003", new Date(), 150000, "9876543210", "Rent payment");
        transfer.process(customer);

        // Pay Bill
        Transaction billPayment = new BillPayment("TX004", new Date(), 100000, "BL001", "M-Banking");
